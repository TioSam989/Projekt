    ...
    if(isset($_SESSION['validado'])){
        ...
        ?>
			...
			if(true){
				...
				mysqli_query($mysqli, "update mensagens set mensagem=$teste where id_mensagens=1");
				$dadosMsg = mysqli_query($mysqli, "select * from mensagens where id_mensagens='1'");
				$linha = mysqli_fetch_assoc($dadosMsg);
				
				$code_msg = $linha['mensagem'];
