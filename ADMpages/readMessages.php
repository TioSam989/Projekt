...
$messages_buffer_file = "../backup-chat/$variavelMeh.json";
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var poll_for_new_messages = function(){
				$.ajax({url: '../backup-chat/<?php echo $variavelMeh ?>.json', dataType: 'json', ifModified: true, timeout: 2000, success: function(messages, status){
