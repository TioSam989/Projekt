...
$result = mysqli_query($mysqli, "SELECT * FROM login where ativo='N'");
...
$resultado = mysqli_query($mysqli, "SELECT * FROM login where ativo='N' ");

if (isset($_POST['procura'])){
	$valor_a_procurar=$_POST['id'];
	$resultado = mysqli_query($mysqli, "SELECT * FROM login where ativo='N' AND nome like'%".$valor_a_procurar."%' OR email LIKE'%".$valor_a_procurar."%' OR username LIKE'%".$valor_a_procurar."%' OR turma LIKE'%".$valor_a_procurar."%' OR sexo LIKE'%".$valor_a_procurar."%' OR born LIKE'%".$valor_a_procurar."%'  ");
}
	...
	<div class="login">
        <form action="#" method="POST" class="login-form">
            <div class="form-input-material">
                <center><h2>Usuarios desativados</h2></center>
